d3.json("./data/pie-chart_all.json", function(data) {

    // range of slider
    var data_length = Object.keys(data).falength - 1;
    ...
    // update the slices of the 2nd pie chart
    function updateArcs2() {
        var json2 = getData();

        d3.selectAll("#pie2 path title")
            .text(function(d, i) {
                return json[i].value + '%';
            });

        d3.selectAll("#pie2 path")
            .data(pie(json2))
            .transition()
            .duration(200)
            .attrTween('d', arcTween);
